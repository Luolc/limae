...
- **A4 / A6 黄金集交叉依赖**：`experimental-zh-zero-noun` 自带行内禁用指令，A4 文档集成时须按真实结果保留该整组的 A6 依赖，不能过滤被指令影响的 finding 后声称完整通过；A6 后与全部黄金集一起验收 (见 [PR #90 合并说明](https://github.com/Luolc/limae/pull/90#issuecomment-5559406320))。
